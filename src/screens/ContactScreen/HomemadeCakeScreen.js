...
import homemadecakedata from "./data/homemadecake";

const HomemadeCakeScreen = () => {
  return (
    <div>
      <Header />
      <h3 className="heading text-center pt-1 my-2">Homemade Cake Bakers:</h3>
      <div className="page">
        {" "}
        <Row className="row p-2 text-center">
          {homemadecakedata.map((categorydata, index) => (
...
export default HomemadeCakeScreen;
