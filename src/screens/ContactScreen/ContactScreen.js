...
const ContactScreen = () => {
  return (
    <>
      ...
      <ContactCardComponent title="Hotels" Img={hotel} link="/contact/hotel" />
      ...
      <ContactCardComponent title="Generator" Img={generatorsonhire} link="/" />
      <ContactCardComponent
        title="Graphic Designers"
        Img={graphicdesigners}
        link="/"
      />
      <ContactCardComponent title="House Keeping" Img={housekeeping} link="/" />
      ...
      <ContactCardComponent
        ...
        link="/"
      />
      <ContactCardComponent title="Personal Care" Img={personalcare} link="/" />
      <ContactCardComponent
        title="Photographers"
        Img={photographers}
        link="/"
      ...
      <ContactCardComponent title="Wedding Requisites" Img={wedding} link="/" />
