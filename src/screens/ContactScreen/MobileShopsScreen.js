...
import mobileshopsdata from "./data/mobileshops";

const MobileShopsScreen = () => {
  return (
    <div>
      <Header />
      <h3 className="heading text-center pt-1 my-2">Mobile Shops:</h3>
      <div className="">
        {" "}
        <Row className="row p-2 text-center">
          {mobileshopsdata.map((categorydata, index) => (
...
export default MobileShopsScreen;
